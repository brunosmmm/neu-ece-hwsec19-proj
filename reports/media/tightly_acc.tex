...
\begin{tikzpicture}
  ...
  \begin{scope}[name=datapath, local bounding box=dpathbb]
    ...
    \draw[ultra thick] (3.75, 1) node [circle, minimum size=4pt, fill, inner sep=0pt] {} -- ++(0, -3.5);
    \draw[ultra thick] (6, 1) node [circle, minimum size=4pt, fill, inner sep=0pt] {} -- ++(0, -3.5);
    ...
    \draw[ultra thick] (4.65, -5.5) node [circle, minimum size=4pt, fill, inner sep=0pt] {} -- ++(0, 2.5);
